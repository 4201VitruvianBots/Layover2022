...
//         PathPlanner.loadPath("FiveBallAuto-1", Units.feetToMeters(6), Units.feetToMeters(2),
// false);

//     PathPlannerTrajectory trajectory2 =
//         PathPlanner.loadPath("FiveBallAuto-2", Units.feetToMeters(14), Units.feetToMeters(7),
// false);

//     PathPlannerTrajectory trajectory3 =
//         PathPlanner.loadPath("FiveBallAuto-3", Units.feetToMeters(14), Units.feetToMeters(7),
// false);

//     PathPlannerTrajectory trajectory4 =
//         PathPlanner.loadPath("FiveBallAuto-4", Units.feetToMeters(14), Units.feetToMeters(7),
// false);
...
//         new AutoRunIndexer(indexer, flywheel, 0.6).withTimeout(0.9),
...
//         new ParallelDeadlineGroup(command3.andThen(() -> swerveDrive.drive(0, 0, 0, false,
// false))),
//         new AutoRunIntakeIndexer(intake, indexer).withTimeout(1), // change this to 1.5? more
//         new IntakePiston(intake, false),

//         // // Path 4 + shoot 2
//         new ParallelDeadlineGroup(command4.andThen(() -> swerveDrive.drive(0, 0, 0, false,
// false))),
//         new IntakePiston(intake, false),
