  ...
  public FiveBallAutoRed(
    ...
    PathPlannerTrajectory trajectory1 =
        PathPlanner.loadPath(
            "FiveBallAuto-Red-1", Units.feetToMeters(16), Units.feetToMeters(8), false);

    PathPlannerTrajectory trajectory2 =
        PathPlanner.loadPath(
            "FiveBallAuto-Red-2", Units.feetToMeters(18), Units.feetToMeters(11), false);

    PathPlannerTrajectory trajectory3 =
        PathPlanner.loadPath(
            "FiveBallAuto-Red-3", Units.feetToMeters(18), Units.feetToMeters(11), false);

    PathPlannerTrajectory trajectory4 =
        PathPlanner.loadPath(
            "FiveBallAuto-Red-4", Units.feetToMeters(18), Units.feetToMeters(11), false);
