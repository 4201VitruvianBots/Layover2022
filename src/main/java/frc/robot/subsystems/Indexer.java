...
public class Indexer extends SubsystemBase {
  ...
  public Indexer() {
    ...
    indexerMotor.setStatusFramePeriod(1, 255);
    indexerMotor.setStatusFramePeriod(2, 255);
    ...
    kickerMotor.setStatusFramePeriod(1, 255);
    kickerMotor.setStatusFramePeriod(2, 255);
