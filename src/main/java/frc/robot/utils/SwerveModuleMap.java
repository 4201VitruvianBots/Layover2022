...
/**
 * A convenience class that maps {@link ModulePosition}s to any class, e.g. module translations, module states, etc.<p>
...
public class SwerveModuleMap<V> extends HashMap<ModulePosition, V> {
    ...
    /**
     * Creates a {@code SwerveModuleMap} from multiple values, in the order specified in the {@link ModulePosition} enum.<p>
     ...
     *
     * @param values Must have at least as many elements as {@link ModulePosition} has entries. Any entries after will be ignored.
     */
    @SafeVarargs
    ...
    /**
     * Warning: This method does not preserve the module order because it returns a {@link java.util.Collection}. Use {@link #values() values} instead.
     */
    @Deprecated
    @Override
    ...
    /**
     * Returns the values from the map as an {@code Array} in the same order as in the {@link ModulePosition} enum.<p>
